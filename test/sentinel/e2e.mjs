...
// Deterministic dev tokens (must match HMN_ADMIN_TOKENS the sentinel is started with).
...
async function main() {
  ...
  check('console-serves', consoleRes.status === 200 && consoleRes.body.includes('Audit Console') && consoleRes.body.includes('view-overview'),
