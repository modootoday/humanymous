...
> **TODO(verify):** whether request bodies larger than the HTTP/2 upload-buffer cap are streamed to origin or bounded/rejected, and any configurable max request-body size beyond the per-connection buffer.
