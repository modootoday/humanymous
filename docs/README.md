...
- **[Cut a release](how-to/cut-a-release.md)** — SemVer `v*` tags drive ghcr.io images and git-cliff release notes generated from Conventional Commits; the version-bump rules and the release flow.
