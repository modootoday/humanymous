  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "humanymous is a defensive, open-source reference system for studying browser-automation detection. Core demonstrates the complete seven-stage pipeline. Gate is the reverse-proxy enforcement component and scores the smaller evidence set its current collector supplies."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No third-party CAPTCHA service is required. The reference includes proof-of-work and Pass components, but Gate does not wire them into a complete recovery flow for every challenged visitor. A deployment must provide and test its accessible flow."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Core demonstrates the complete seven-stage pipeline. Gate scores the evidence its current collector supplies and maps the result to ALLOW, CHALLENGE, or DENY. Enforcement rules can raise the score-based result. The reference Gate does not provide a complete visitor-recovery flow for every challenge."
      }
    },
    {
      "@type": "Question",
