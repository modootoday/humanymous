...
**Audience:** integrators and platform engineers deciding where to place humanymous, and evaluators checking which evidence is available before benchmarking.
...
This repository is a **reference implementation**, not a production-hardened build. Where a capability is deferred to production, this page says so and links [production vs reference](./production-vs-reference.md).
