...
<video autoplay loop muted playsinline poster="../assets/screenshots/anim/ledger-live-poster.webp" width="820" style="max-width:100%;border-radius:12px" aria-label="The Ledger Overview view: a live scrolling feed of edge decisions (ALLOW / CHALLENGE / DENY) with hard-rule badges and recent-window counters.">
...
3. **[The Ledger](https://localhost:8445/__hmn/admin/console)** — the live surface itself, seven views: Overview (live edge decisions), Integrity, Sessions (incident drill-down), Rate Limits & Bans, Policy, Approvals (the dual-control commit queue), and Compliance.
