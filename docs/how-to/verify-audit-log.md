...
> **Note:** The data in the log is **pseudonymous, not anonymous** (GDPR Recital 26). Re-identification requires the vault plus dual-control. Verification never needs to resolve a pseudonym — it checks structure and signatures, not subject identity.
