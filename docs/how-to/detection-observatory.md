...
<picture>
  ...
  <img src="../assets/screenshots/framed/observatory-light.webp" alt="The Detection Observatory scoring a headless puppeteer session live: an 82.4 DENY with HR-7 fired, the L1→L7 pipeline of signals, and the server-truth hard-rule ladder showing HR-7 winning over the score band, beside the Red launcher catalog." />
</picture>
