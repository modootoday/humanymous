...
for r in 00-safety.md 10-go-conventions.md 20-detection-freeze.md 30-docs-diataxis.md 40-ambiguity-ask.md 50-provider-matrix.md 60-e2e-docker-only.md 70-hard-won-lessons.md 80-truth-debt.md; do
