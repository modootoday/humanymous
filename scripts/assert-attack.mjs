...
export function evaluateAttackResults(records, expectedProfiles = 66) {
...
export function main(path = process.argv[2] || '/artifacts/core-results.json') {
  ...
  const result = evaluateAttackResults(records, Number(process.env.HM_EXPECTED_PROFILES || 66));
