...
const (
	...
	// Network plane residuals (score-exempt). Operators detect via Audit stream and
	// block via Ban (ip:/fp:/cidr:) — these do NOT move the risk score dial.
	EventNetProxyHop          = "net.proxy.hop"
	EventNetClientIPSpoof     = "net.proxy.client_ip_spoof"
	EventNetXFFMultiHop       = "net.proxy.xff_multi_hop"
	EventNetForwardedPrivate  = "net.proxy.forwarded_private"
	EventNetAnonChain         = "net.proxy.anon_chain"
	EventNetVPNWebRTC         = "net.vpn.webrtc_leak"
	EventNetTorCircuit        = "net.tor.circuit"
	EventNetTorExit           = "net.tor.exit"
	EventNetIPDatacenter      = "net.ip.datacenter"
	EventNetIPProxyVPN        = "net.ip.proxy_vpn"
	EventNetTCPNotObserved    = "net.tcp.not_observed"
	EventNetTCPFingerprint    = "net.tcp.fingerprint"
	EventNetTCPTTLOS          = "net.tcp.ttl_os_mismatch"
	EventNetProxyRotation     = "net.correlation.proxy_rotation"
	EventNetFPChurn           = "net.correlation.fp_churn"
	EventNetSharedFP          = "net.correlation.shared_fingerprint"
	EventNetIPHop             = "net.traffic.ip_hop"
